...
const isUsingReact = "react" in (pkgJsonData.dependencies || {}) ||
    "react" in (pkgJsonData.devDependencies || {}) ||
    "react" in (pkgJsonData.peerDependencies || {});
const isUsingTypeScript = fs.existsSync(tsJson);
...
if (isUsingTypeScript) {
    ...
    config.extends.push("plugin:@typescript-eslint/recommended-requiring-type-checking");
}
if (isUsingReact) {
