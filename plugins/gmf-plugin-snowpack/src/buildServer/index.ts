import { loadConfiguration, SnowpackConfig, SnowpackUserConfig, startServer } from 'snowpack';
...
export class BuildServer {
  ...
  private async _tryLoadConfig(configPath: string, overrides: SnowpackUserConfig): Promise<SnowpackConfig | undefined> {
    try {
