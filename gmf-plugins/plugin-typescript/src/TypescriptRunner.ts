...
import { BuildCommandParameters } from "@nfts/gmf";
...
export class TypescriptRunner {
  ...
  public async _runBuild(
    ...
    }: { commandLineParameters: BuildCommandParameters },
    ...
    if (commandLineParameters.tsconfig) {
      ...
      commandLineParameters.tsconfig = Constants.tsconfigPath;
    }
