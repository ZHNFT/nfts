...
var noddy_1 = require("@nfts/noddy");
...
var createCommand = /** @class */ (function (_super) {
    ...
    createCommand.prototype.onExecute = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Generator_1.Generator.run(parameters, process.cwd())];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    createCommand.prototype.onDefineParameters = function () {
...
var Creation = /** @class */ (function (_super) {
    ...
    function Creation() {
        ...
        _this.addCommand(new createCommand());
        return _this;
    }
    return Creation;
}(noddy_1.CommandLine));
exports["default"] = new Creation();
