import { ArgumentsParserError, ArgumentsParserFatalError } from './ArgumentsParserError';
...
export class ArgumentsParser {
   ...
   * 缓存定义的参数配置
   */
  public defineParam(param: IArgumentParam) {
  ...
  public getParamValue(paramName: string): TGoodParameterValueTypes {
    ...
    return ArgumentsParser._transByKind(kind, strParamValue);
  }
   ...
   * @private
   */
  private static _transByKind(kind: TArgumentParamKind, str: string | undefined): TGoodParameterValueTypes {
    switch (kind) {
  ...
  private _tokenKind(str, pos: Token['pos'], prevToken: Token | undefined): TTokenKind {
