...
export class ArgumentsParserResult implements IArgumentsParserResult {
	 ...
	 * @type {}
	 */
	params: Record<string, string | string[] | boolean | number> = Object.create(null);
