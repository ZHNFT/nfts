...
describe('FileSys 单元测试', () => {
  ...
  const absolute_txt =
    '/Users/leiwenpeng/Documents/github/ntfs/libs/ast-node-utils-library/test/dump-files/dump2.txt';
  const absolute_json =
    '/Users/leiwenpeng/Documents/github/ntfs/libs/ast-node-utils-library/test/dump-files/dump1.json';
